          ...
          >
            ...
            >
              ...
              <h1 className="font-serif text-6xl md:text-7xl text-[#FFFEF9] tracking-tight leading-tight">
                <span className="block font-light">L'histoire</span>
                <span className="block font-normal italic">d'Amarea</span>
              </h1>
            </motion.div>
            ...
            >
              Créateur de mariages d'exception depuis 2019, nous transformons vos rêves 
              en réalité avec une expertise reconnue et une passion inébranlable
            </motion.p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div className="space-y-4">
                ...
                <h2 className="font-serif text-4xl md:text-5xl text-[#2C2C2C] font-light leading-tight">
                  Une passion devenue
                  <span className="block italic mt-2">métier</span>
                </h2>
              </div>
              ...
              <div className="border-l-2 border-[#C9A96E] pl-6 py-4">
                <p className="font-serif text-xl text-[#2C2C2C] italic font-light leading-relaxed">
                  "Créer des moments d'exception est notre raison d'être"
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="font-serif text-5xl md:text-6xl text-[#2C2C2C] font-light mb-6">
              Les principes qui <span className="italic">nous guident</span>
            </h2>
          </motion.div>
          ...
          >
            <div className="space-y-6">
              <h2 className="font-serif text-5xl md:text-6xl text-[#2C2C2C] font-light">
                Prêt à créer votre
                <span className="block italic mt-2">mariage d'exception ?</span>
              </h2>
              <p className="text-[#5C5C5C] text-lg max-w-2xl mx-auto font-light leading-relaxed">
                Découvrez comment nous pouvons transformer vos rêves en réalité 
                avec notre expertise et notre passion du détail
              </p>
            </div>
